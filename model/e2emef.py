...
from model.gfu.guided_filter import FastGuidedFilter, GuidedFilter
...
class E2EMEF(nn.Module):
    ...
    def __init__(self, num_exposures=3, radius=1, eps=1e-4, is_guided=True):
        super(E2EMEF, self).__init__()
        self.num_exposures = num_exposures
        self.lr = build_lr_net(layer=self.num_exposures)
